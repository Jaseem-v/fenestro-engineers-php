                ...
                <div class="col-md-8">
                    <div class="card" style="border-color:#2b2e33">
                        ...
                        <div class="body">
                            ...
                            <form id="basic-form" method="post" action="{{route('admin.slider.editSave',[$result->id])}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="top_title" name="top_title">{{$result?$result->top_title:''}}</textarea>
                                </div>


                                <div class="form-group">
                                    <label>Heading</label>
                                    <textarea class="form-control" id="description" name="heading">{{$result?$result->heading:''}}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" name="btn1Title" value="{{$result?$result->btn1Title:''}}">
                                    </div>

                                    <div class="col">
                                        <label for="examplePassword">Button URL</label>
                                        <input type="text" class="form-control" name="btn1Url" value="{{$result?$result->btn1Url:''}}">
                                    </div>
                                    <div class="col">
                                        <br/><br/>
                                        <label class="checkbox">
                                            <input type="checkbox" value="1" id="inlineCheckbox1"  name="btn1Visible" {{($result?$result->btn1Visible:'')=='1'?'checked':''}}> Visible
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><img id="blah1" width="145" height="145" src="{{url('uploads/'.$result->file.'.webp')}}"></td>
