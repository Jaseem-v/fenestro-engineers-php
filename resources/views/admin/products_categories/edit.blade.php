            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-8 col-sm-12">
                        ...
                        <hr/>
                        <a href="{{route('admin.prod_categories')}}" class="btn btn-dark  btn-sm"><i class="icon-action-undo"></i> Back</a>
                ...
                <div class="col-md-8">
                    <div class="card" style="border-color:#2b2e33">
                        ...
                        <div class="body">
                            ...
                            <form id="basic-form" method="post" action="{{route('admin.prod_categories.editSave',[$result->id])}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Title</label>
                                    <textarea class="form-control" id="title" name="title">{{$result?$result->title:''}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
