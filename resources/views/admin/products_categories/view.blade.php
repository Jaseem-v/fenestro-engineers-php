        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                    <a href="{{route('admin.prod_categories.create')}}" class="btn btn-primary btn-lg"><i class="fa fa-plus-square"></i> Add</a>
                </div>
            </div>
        </div>
        <hr/>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($result as $index=>$item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.prod_categories.editShow',$item->id)}}{{isset($_GET['keyword'])?'?keyword='.$_GET['keyword']:''}}"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form class="submitForm{{$item->id}}" action="{{route('admin.prod_categories.delete', $item->id)}}" method="post">
                                                    @csrf
