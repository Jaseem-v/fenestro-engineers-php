        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                    <a href="{{route('admin.blog.create')}}" class="btn btn-primary btn-lg"><i class="fa fa-plus-square"></i> Add</a>
                </div>
            </div>
        </div>
        <hr/>
                    ...
                    <div class="body table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th width="30%"><h5>Description</h5></th>
                            ...
                            @foreach($result as $index=>$item)
                                ...
                                <tr>
                                    ...
                                    <th scope="row">{{\Carbon\Carbon::parse($item->created_at)->format('m/d/Y')}}</th>
                                    <th scope="row">{{$item->title}}</th>
                                    <th scope="row"><img width="100" height="100" src="{{url('uploads/blog_300_'.$item->file.'.webp')}}"></th>
                                    <th scope="row">{{(strlen($content) > 13) ? substr($content,0,10).'...' : $content}}</th>
                                    <th scope="row">
                                    ...
                                    <td>
                                        <a href="{{route('admin.blog.editShow',$item->id)}}{{isset($_GET['keyword'])?'?keyword='.$_GET['keyword']:''}}"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form class="submitForm{{$item->id}}" action="{{route('admin.blog.delete', $item->id)}}" method="post">
                                                    @csrf
