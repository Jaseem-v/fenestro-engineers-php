                ...
                <div class="col-md-8">
                    <div class="card" style="border-color:#2b2e33">
                        ...
                        <div class="body">
                            ...
                            <form id="basic-form" method="post" action="{{route('admin.blog.editSave',[$result->id])}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" id="description" name="description">{{$result->description}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><img id="blah1" width="145" height="145" src="{{url('uploads/blog_300_'.$result->file.'.webp')}}"></td>
